    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a CSV file with columns: name, description, category, difficulty, muscle_group, equipment, instructions, is_bodyweight, is_compound, video_url. AI metadata (movement_pattern, primary/secondary muscles, force_type, laterality, equipment_required) can be generated by Claude. Use pipe (|) to separate multiple values.
          </DialogDescription>
        </DialogHeader>
