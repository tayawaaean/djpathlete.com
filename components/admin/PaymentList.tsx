  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl border border-border p-3 sm:p-4">
          <div className="flex items-center gap-2 sm:gap-3 mb-1.5">
            <div className="flex size-8 sm:size-9 items-center justify-center rounded-lg bg-accent/10">
              <TrendingUp className="size-3.5 sm:size-4 text-accent" />
            </div>
            <p className="text-xs sm:text-sm text-muted-foreground">This Month</p>
          </div>
          <p className="text-xl sm:text-2xl font-semibold text-primary">{formatCents(thisMonthRevenue)}</p>
        </div>
        <div className="bg-white rounded-xl border border-border p-3 sm:p-4 col-span-2 sm:col-span-1">
          <div className="flex items-center gap-2 sm:gap-3 mb-1.5">
          ...
          <p className="text-xl sm:text-2xl font-semibold text-primary">{payments.length}</p>
        </div>
      </div>
