...
const CATEGORIES = ["strength", "cardio", "flexibility", "plyometric", "sport_specific", "recovery"]
...
const EXERCISE_COLUMNS: ColumnDef[] = [
  ...
  { header: "Compound?", key: "is_compound", width: 14, hint: "Select from dropdown", dropdown: BOOL_OPTIONS },
...
export async function generateExerciseTemplate(): Promise<Blob> {
  ...
  const instructionRows = [
    ...
    { field: "Compound?", required: "No", description: "Does it target multiple muscle groups?", values: "TRUE or FALSE" },
