...
const newExercises = [
  ...
  },
  {
    ...
    category: "plyometric", muscle_group: "core", difficulty: "beginner",
...
const day1: ExSlot[] = [
  {
    exercise_id: RX.pallof_press, rest_seconds: 60,
  ...
  {
    exercise_id: RX.dead_bug, rest_seconds: 45,
  ...
  {
    exercise_id: RX.bird_dog, rest_seconds: 45,
    foundation: { sets: 3, reps: "8/side",  rpe: 5, tempo: null,   notes: null },
    build:      { sets: 3, reps: "10/side", rpe: 6, tempo: "2020", notes: null },
    intensify:  { sets: 4, reps: "12/side", rpe: 7, tempo: "2020", notes: null },
  },
  {
    exercise_id: RX.side_plank, rest_seconds: 45,
  ...
  {
    exercise_id: EX.plank, rest_seconds: 45,
  ...
  {
    exercise_id: RX.goblet_squat, rest_seconds: 90,
  ...
  {
    exercise_id: EX.bulgarian_split, rest_seconds: 90,
...
const day2: ExSlot[] = [
  {
    exercise_id: RX.cable_woodchop_high_low, rest_seconds: 60,
  ...
  {
    exercise_id: RX.cable_woodchop_low_high, rest_seconds: 60,
    foundation: { sets: 3, reps: "10/side", rpe: 5, tempo: null,   notes: null },
    build:      { sets: 3, reps: "12/side", rpe: 6, tempo: "2010", notes: null },
    intensify:  { sets: 4, reps: "12/side", rpe: 7, tempo: "2010", notes: "Drive from hips, explosive lift" },
  },
  {
    exercise_id: RX.rotational_mb_throw, rest_seconds: 60,
  ...
  {
    exercise_id: RX.russian_twist, rest_seconds: 45,
  ...
  {
    exercise_id: EX.med_ball_slam, rest_seconds: 60,
...
const day3: ExSlot[] = [
  ...
  {
    exercise_id: RX.sl_rdl, rest_seconds: 90,
    foundation: { sets: 3, reps: "8/leg",  rpe: 6, tempo: null,   notes: null },
  ...
  {
    exercise_id: EX.hip_flexor, rest_seconds: 0,
...
const day4: ExSlot[] = [
  {
    exercise_id: RX.cable_woodchop_high_low, rest_seconds: 45,
  ...
  {
    exercise_id: RX.lateral_lunge, rest_seconds: 60,
    foundation: { sets: 3, reps: "8/side",  rpe: 6, tempo: null,   notes: null },
...
async function seed() {
  ...
  const { count: coreCount } = await supabase
    ...
    .eq("program_id", PROGRAM_ROTATIONAL)
    .in("exercise_id", [
      RX.cable_woodchop_high_low, RX.cable_woodchop_low_high,
      RX.pallof_press, RX.russian_twist, RX.rotational_mb_throw,
      RX.dead_bug, RX.bird_dog, RX.side_plank,
      RX.hk_cable_chop, RX.hk_cable_lift, RX.copenhagen_plank,
      EX.plank, EX.med_ball_slam,
    ])
  ...
  console.log(`  Legs/Arms:         ${(exCount ?? 0) - (coreCount ?? 0)} (${Math.round((((exCount ?? 0) - (coreCount ?? 0)) / (exCount ?? 1)) * 100)}%)`)
  console.log("  ─────────────────────────────────────────────────────")
